...
import { EASE, UiCheckbox, UiChip, UiCluster, UiIconButton, UiSwitch, UiStack, cubicBezierCss, useMotion } from '@/design-system'
...
<template>
  <MotionDemo
    ...
    :specs="[
      { label: 'Сердце', value: 'WAAPI element.animate(): scale 1 → 1.3 → 1, 350 мс, ease-out' },
